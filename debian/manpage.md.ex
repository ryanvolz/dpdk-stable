% dpdk-for-jetson(SECTION) | User Commands
%
% "March  7 2025"
...
dpdk-for-jetson - program to do something

# SYNOPSIS

**dpdk-for-jetson** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**dpdk-for-jetson** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **dpdk-for-jetson** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**dpdk-for-jetson** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    dpdk-for-jetson. See **foo.conf**(5) for further details.
...
**dpdk-for-jetson** provides some return codes, that can be used in scripts:
